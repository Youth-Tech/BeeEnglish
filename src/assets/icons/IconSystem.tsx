...
const LeftArrow = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => {
    console.log(props)
    return (
        <Svg
...
const RightArrow = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Profile = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Microphone = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
...
const SendPaper = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const Setting = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 22}
        height={props.size || props.height || 22}
        fill="none"
...
const MenuHeading = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Comment = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const MuteAudio = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
...
const WaveAudio = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Bookmark = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 20}
        height={props.size || props.height || 20}
        fill="none"
...
const Player = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 20}
        height={props.size || props.height || 24}
        fill="none"
...
const RePlay = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill={fill}
...
const DisLike = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 20}
        height={props.size || props.height || 20}
        fill={fill}
...
const Like = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 20}
        height={props.size || props.height || 20}
        fill="none"
...
const Cancel = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const SendComment = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const PenBrush = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Password = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Crown = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const Notification = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Agree = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
...
const Lock = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
...
const Logout = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const StartOutLine = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const StartFill = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 21}
...
const About = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const History = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const Dictionary = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
...
const ShowPassword = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
...
const HidePassword = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 17}
...
const BackGame = ({fill = initialState.fill, stroke = initialState.stroke, ...props}: Props) => (
    <Svg
        width={props.size || props.width || 24}
        height={props.size || props.height || 24}
        fill="none"
